  ...
  return (
    <div className="bg-white">
                            ...
                            >
                              {section.items.map((item) => (
                                <li key={item.name} className="flow-root">
                                  <p className="-m-2 block p-2 text-gray-500" onClick={()=>navigate(`/${category.id}/${section.id}/${item.id}`)}>
                                    {item.name}
                                  </p>
                                </li>
                              ))}
      ...
      <header className="relative bg-white">
        <p  className="flex h-10 items-center justify-center bg-indigo-600 px-4 text-sm font-medium text-white z-100 sm:px-6 lg:px-8">
        ...
        <nav aria-label="Top" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="border-b border-gray-200">
            <div className="flex h-16 items-center">
              ...
              {/* Flyout menus */}
              <Popover.Group className="hidden lg:ml-8 lg:flex lg:self-stretch lg:z-50">
