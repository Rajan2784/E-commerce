  ...
  return (
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        {/* Product info */}
        <div className="lg:col-span-1 max-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
                <div className='flex items-center space-x-3'>
                    ...
                    <p className='opacity-50 text-sm'>5649 Ratings </p>
                    <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>960 Reviews </p>
                </div>
            </div>
        ...
        <section>
            ...
            <div className='border p-5'>
                    <Grid container spacing={7} columns={{ xs: 4, sm: 8, md: 12 }}>
                        <Grid item xs={7}>
                        ...
                        <Grid item xs={5}>
                            <h1 className='text-xl font-semibold pb-2'>Product Raings</h1>

                            <div className='flex items-center space-x-3'>
                                <Rating name='read-only' value={4.6} precision={0.5} readOnly />
                                <p className='opacity-60'>599 Ratings</p>
                            </div>
        ...
        <section className='pt-10'>
            <h1 className='py-5 text-xl font-bold pl-2'>Similar Products</h1>

            <div className='flex flex-wrap justify-center space-y-5'>
                {mens_kurta.map((item)=> <HomeCard item={item} />)}  
            </div>
